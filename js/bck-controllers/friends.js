'use strict';
app.controller('FriendsCtrl', ['$scope', '$http', '$state', 'authServices', '$timeout', 'webServices', 'utility', '$rootScope', function($scope, $http, $state, authServices, $timeout, webServices, utility, $rootScope) {
    ...
    $scope.pageChanged = function(newPage,type) {
        ...
        if(type == 'friends'){
            ...
            if (!$scope.friendspagedata[$scope.friendspageno]) {
                ...
                $scope.otherpeoples = $scope.friendspagedata[$scope.friendspageno];
            }
